...
public class CheaterPlayerTest {
    /**
     * Cheater ModelPlayer to test.
     */
    ModelPlayer d_player;

    /**
     * Opponent ModelPlayer to test.
     */
    ModelPlayer d_randomPlayer;
    ...
    public void setup() {
        ...
        d_country1.addNeighbours(3); // Spain ---> Portugal
        d_country1.addNeighbours(2); // Spain ---> France
        l_country2.addNeighbours(3); // France ----> Portugal
        ...
        l_continent.setD_countriesList(l_allCountries);
        ...
        d_player = new ModelPlayer("DummyPlayer");
        ...
        d_randomPlayer = new ModelPlayer("Opponent");
