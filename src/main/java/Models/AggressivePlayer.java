...
/**
 * This is the class of Aggressive ModelPlayer, who gathers all his armies, attacks
...
public class AggressivePlayer extends PlayerBehaviorStrategy {
	 ...
	 */
	public void moveArmiesFromItsNeighbors(ModelPlayer p_player, Country p_randomSourceCountry, GameState p_gameState) {
	...
	public String createCardOrder(ModelPlayer p_player, GameState p_gameState, String p_cardName) {
		Random l_random = new Random();
		Country l_StrongestSourceCountry = getStrongestCountry(p_player, p_gameState);
	 ...
	 */
	public Country getStrongestCountry(ModelPlayer p_player, GameState p_gameState) {
