 ...
 * This abstract class provides a framework for different game phases, such as editing the map, issuing orders, etc.
 */
...
public abstract class Phase implements Serializable {
     ...
     * @throws IOException                If an I/O error occurs.
     */
	protected abstract void performLoadGame(CommandHandler p_command, ModelPlayer p_player) throws CommandValidationException, MapValidationException, IOException;
    /**
     ...
     * @throws IOException                If an I/O error occurs.
     */
    protected abstract void performSaveGame(CommandHandler p_command, ModelPlayer p_player) throws CommandValidationException, MapValidationException, IOException;
    /**
     ...
     * @throws MapValidationException     If map validation fails.
     */
	protected abstract void tournamentGamePlay(CommandHandler p_command) throws CommandValidationException, MapValidationException;
    /**
     ...
     * @throws MapValidationException     If map validation fails.
     */
	protected abstract void performAssignCountries(CommandHandler p_command, ModelPlayer p_player, boolean p_isTournamentMode, GameState p_gameState)
			throws CommandValidationException, IOException, MapValidationException;
    /**
