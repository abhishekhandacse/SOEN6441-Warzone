...
public class ModelAdvance implements Order, Serializable {
	...
	private void conquerTargetCountry(GameState p_gameState, ModelPlayer p_playerOfTargetCountry, Country p_targetCountry) {
		...
		this.setD_orderExecutionLog(
				"ModelPlayer : " + this.d_playerInitiator.getPlayerName() + " is assigned with Country : "
	 ...
	 * @param p_sourceCountry         source country given in order
	 */
	private void produceAdvanceResult(GameState p_gameState, ModelPlayer p_playerOfTargetCountry, Country p_targetCountry,
			Country p_sourceCountry) {
